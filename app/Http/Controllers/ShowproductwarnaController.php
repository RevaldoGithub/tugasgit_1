...
class ShowproductwarnaController extends Controller
{
    /**
    ...
    public function show($id, Request $request)
    {
        ...
        $katewars = Katewar::where('slug', $id)->first();
        $katewars_1 = Katewar::all();
        ...
        return view('homepage.products.detail-warna', compact('config', 'metamanagement', 'bgbanner', 'footer_blog', 'footer_service', 'products', 'katewars_1', 'katewars', 'top_product', 'katepros_1'))->with('i', (request()->input('page', 1) - 1) * 10);
    }
