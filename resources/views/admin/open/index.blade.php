                ...
                <div class="tab-menu-heading tab-menu-heading-boxed">
                    <div class="tabs-menu-boxed">
                        ...
                        <ul class="nav panel-tabs">
                            <li><a href="#tab25" class="active" data-bs-toggle="tab">Open Work Perusahaan</a></li>
                        ...
                        <div class="tab-pane active" id="tab25">
                            <div class="table-responsive">
                                <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                                    <thead>
                                        <tr class="text-wrap">
                                            <th class="wd-20p border-bottom-0">Hari</th>
                                            <th class="wd-15p border-bottom-0">Jam</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $sc->jam }}</td>
                                            <td>
                                                <form action="{{ route('open.destroy',$sc->id) }}" method="POST">

                                                    <a class="btn btn-primary" href="{{ route('open.edit', $sc->id) }}">
