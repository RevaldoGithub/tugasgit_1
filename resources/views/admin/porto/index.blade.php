                ...
                <div class="tab-menu-heading tab-menu-heading-boxed">
                    <div class="tabs-menu-boxed">
                        ...
                        <ul class="nav panel-tabs">
                            <li><a href="#tab25" class="active" data-bs-toggle="tab">Portfolio </a></li>
                                ...
                                <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $sc->judul }}</td>
                                            <td>
                                                <form action="{{ route('porto.destroy',$sc->id) }}" method="POST">

                                                    <a class="btn btn-primary" href="{{ route('porto.edit', $sc->id) }}">
