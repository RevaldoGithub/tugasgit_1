                ...
                <div class="tab-menu-heading tab-menu-heading-boxed">
                    <div class="tabs-menu-boxed">
                        ...
                        <ul class="nav panel-tabs">
                            <li><a href="#tab25" class="active" data-bs-toggle="tab">Why Choose Us</a></li>
                                ...
                                <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <td>{{ $sc->judul }}</td>
                                            <td>
                                                <form action="{{ route('why.destroy',$sc->id) }}" method="POST">

                                                    <a class="btn btn-primary" href="{{ route('why.edit', $sc->id) }}">
