                ...
                <div class="tab-menu-heading tab-menu-heading-boxed">
                    <div class="tabs-menu-boxed">
                        ...
                        <ul class="nav panel-tabs">
                            <li><a href="#tab25" class="active" data-bs-toggle="tab">Home Management User</a></li>
                                ...
                                <table class="table table-bordered text-nowrap border-bottom" id="basic-datatable">
                                    <thead>
                                        <tr>
                                            ...
                                            <th class="wd-20p border-bottom-0">Gmail</th>
                                    ...
                                    <tbody>
                                        ...
                                        <tr>
                                            ...
                                            <!-- <td>{{ $akn->password }}</td> -->
                                            <td>
                                                <form action="{{ route('akun.destroy',$akn->id) }}" method="POST">

                                                    <a class="btn btn-primary" href="{{ route('akun.edit', $akn->id) }}">
